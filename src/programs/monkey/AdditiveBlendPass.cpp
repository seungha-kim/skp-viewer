...
public:
    explicit AdditiveBlendPassPimpl(const SurfaceInfo& surfaceInfo)
            : m_colorTexture(surfaceInfo.physicalWidth, surfaceInfo.physicalHeight)
            , m_textureRenderer(std::make_unique<Shader>("quad.vert", "additiveBlend.frag")) {
...
AdditiveBlendPass::AdditiveBlendPass(const SurfaceInfo &surfaceInfo): m_pimpl(std::make_unique<AdditiveBlendPassPimpl>(surfaceInfo)) {}
