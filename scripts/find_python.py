...
parser.add_argument('--include', dest="is_include", action="store_const", const=True, default=False)
parser.add_argument('--lib', dest="is_lib", action="store_const", const=True, default=False)
